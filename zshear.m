...
elseif length > 0 && length <= 0.4
    ...
    Mz = R0(3)*length;
    tau = 0;
    thetaY = 1/(E*Iy)*(R0(2)*length^2/2 + C1(1));
    thetaZ = 1/(E*Iz)*(R0(3)/2*length^2 + C1(2));
...
elseif length >= 0.4 && length < 0.75
    ...
    tau = FA(3)*0.3;
    thetaY = 1/(E*Iy)*(R0(2)/2*length^2-FA(2)/2*(length-0.4)^2 + C1(1));
    thetaZ = 1/(E*Iz)*(R0(3)/2*length^2-FA(3)/2*(length-0.4)^2 + C1(2));
...
elseif length >= 0.75 && length < 1.05
    ...
    thetaY = 1/(E*Iy)*(R0(2)/2*length^2-FA(2)/2*(length-0.4)^2-FB(2)/2*(length-0.75)^2 + C1(1));
    thetaZ = 1/(E*Iz)*(R0(3)/2*length^2-FA(3)/2*(length-0.4)^2+FB(3)/2*(length-0.75)^2 + C1(2));
    ...
    tau = FA(3)*0.3 + FB(3)*0.15;
    thetaY = 1/(E*Iy)*(R0(2)/2*length^2-FA(2)/2*(length-0.4)^2-FB(2)/2*(length-0.75)^2+RC(2)/2*(length-1.05)^2 + C1(1));
    thetaZ = 1/(E*Iz)*(R0(3)/2*length^2-FA(3)/2*(length-0.4)^2+FB(3)/2*(length-0.75)^2+RC(3)/2*(length-1.05)^2 + C1(2));
